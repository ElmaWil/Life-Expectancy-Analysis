...
**Life Expectancy Dashboard Report**

**By Ezichi Williams John**

## Overview

This dashboard presents a comprehensive analysis of global life expectancy trends, covering multiple countries between the years 2000 and 2015.It visually summarizes health, economic, demographic, and environmental factors influencing life expectancy in both developed and developing nations.  The dashboard is based on a **cleaned dataset** and structured **SQL queries** executed in **DB Browser for SQLite**.

## Objectives

The main aim was is to analyse the global life expectancy trends, how developed and developing countries differ, and understand how factors like adult mortality, GDP, schooling, health expenditure, diseases, immunization, and malnutrition influence differences between countries.

## Key Metrics

The Power BI dashboard uses **Card visuals** to show important summary metrics:
...
\- Slicers for filtering by year, country, and status  
\- A table for detailed breakdowns
...
The dashboard provides a clear and interactive summary, making it useful for analysis, reporting, and identifying areas where improvement is still needed. The insights gained here can help guide better policies, planning, and health interventions.
